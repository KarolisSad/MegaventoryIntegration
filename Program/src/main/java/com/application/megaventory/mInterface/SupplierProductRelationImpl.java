...
@Service
public class SupplierProductRelationImpl implements SupplierProductRelationInterface {

    @Override
    public String createSupplierProductRelation(String supplierID, String productID) throws JSONException {
        // Message body
        JSONObject requestBody = new JSONObject();
        JSONObject mvRelation = new JSONObject();
        requestBody.put("APIKEY", MyApiClass.API_KEY);
        mvRelation.put("ProductID", productID);
        mvRelation.put("ProductSupplierID", supplierID);
        requestBody.put("mvProductSupplierUpdate", mvRelation);
